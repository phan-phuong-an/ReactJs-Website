...
import './DashboardForm.css'; // Import CSS

// Helper: Chuyển đổi trạng thái boolean (Nam/Nữ, Đạt/Không đạt)
...
// Hàm chuyển đổi string date sang Date object (cần cho DatePicker)
...
export default function DashboardForm({ initial = null, onCancel, onSubmit }) {
