    ...
    const fetchData = async (currentPage = page) => {
        ...
        setError(null);
           ...
           try {
                ...
                const msg = err?.data?.message || 'Không thể tải dữ liệu Dashboard';
    ...
    return (
        <div className="dashboard-container">
            ...
            <div className="dashboard-toolbar">
                <h2 style={{ margin: 0, color: '#333' }}>Dashboard Sàng lọc</h2>
                        ...
                        {filteredData.length === 0 && !loading ? (
                            ...
                            filteredData.map((row) => (
                                <tr key={row.id}>
                                    ...
                                    <td>
                                        <div className="cell-detail"><b>Người làm:</b> {row.surverBy}</div>
                                        <div className="cell-detail"><b>Tại:</b> {row.surverPlace}</div>
